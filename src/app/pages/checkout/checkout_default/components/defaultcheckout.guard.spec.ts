...
import { DefaultCheckoutGuard } from './defaultcheckout.guard';
import {
...
describe('UserService', () => {
  let defaultCheckoutGuard: DefaultCheckoutGuard;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      providers: [DefaultCheckoutGuard],
      ...
      .then(() => {
        ...
        defaultCheckoutGuard = TestBed.get(DefaultCheckoutGuard);
      });
  }));
  ...
  it('Check DefaultCheckoutGuard instance is available', () => {
    expect(defaultCheckoutGuard).toBeTruthy();
  });
  it('Should call - canActivate', () => {
    ...
    defaultCheckoutGuard.canActivate(route, state);
    expect(defaultCheckoutGuard).toBeTruthy();
  });
});
