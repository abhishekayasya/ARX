...
describe('HdPrescriptionComponent12', () => {
  let component: HdTransferBaseComponent;
  let fixture: ComponentFixture<HdTransferBaseComponent>;
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [HdTransferBaseComponent],
      imports: [
        SharedModule,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(HdTransferBaseComponent);
